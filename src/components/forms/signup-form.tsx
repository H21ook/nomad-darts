    ...
    return (
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <div className="text-center space-y-1 pb-2">
                <h2 className="text-3xl font-black tracking-tight uppercase italic">Create Account</h2>
                ...
                <FieldGroup className="space-y-2">
                    <Field>
                        ...
                        <Input
                            ...
                            className="h-12 bg-white/2 border-white/5 focus-visible:border-primary/50 focus-visible:ring-primary/10 rounded-xl transition-all"
                            required
                            {...register("email")}
                    ...
                    <Field>
                        <FieldLabel htmlFor="password" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/60 ml-1">
                            Password
                        </FieldLabel>
                        <InputGroup className="h-12">
                            <InputGroupInput
                                ...
                                className="h-12 bg-white/[0.02] border-white/5 focus-visible:border-primary/50 focus-visible:ring-primary/10 rounded-xl transition-all"
                                {...register("password")}
                    ...
                    <Field >
                        <FieldLabel htmlFor="confirm-password" className="text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground/60 ml-1">
                            Confirm Password
                        </FieldLabel>
                        <InputGroup className="h-12">
                            <InputGroupInput
                        ...
                        {errors.confirmPassword && (
                            <FieldDescription id="confirm-password-error" className="text-destructive text-[10px] font-bold ml-1">
