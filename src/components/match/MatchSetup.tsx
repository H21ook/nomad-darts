...
const DEFAULT_PLAYERS: PlayerInit[] = [
    { id: nanoid(), name: '', color: PLAYER_COLORS[0] },
    { id: nanoid(), name: '', color: PLAYER_COLORS[1] },
];
...
export function MatchSetup() {
    ...
    return (
        <div className="flex flex-col h-dvh w-full text-foreground overflow-hidden">
            <AppBar title={step === 1 ? "Match Setup" : "Player setup"}
            ...
            <div className="relative flex-1 overflow-hidden">
                <AnimatePresence mode="popLayout" custom={direction} initial={false}>
                    {step === 1 ? (
                        ...
                        >
                            <div className='h-[calc(100vh-112px)] px-4 pt-6 pb-26 overflow-y-auto space-y-6'>
                                {/* Game Mode Selection */}
                                <div>
                        ...
                        <motion.div
                            ...
                            transition={{ type: 'spring', stiffness: 300, damping: 30 }}
                        >
                            <div className='h-[calc(100vh-112px)] px-4 pt-6 pb-26 overflow-y-auto no-scrollbar space-y-6'>
                                <div>
                                    <label className="text-sm font-bold uppercase tracking-wider text-muted-foreground">
                                        Starting order
                                    </label>
                                    <div className="flex items-center justify-between mb-4 mt-2">
                                        <span className="text-base font-medium">Randomize starting order</span>
                                        <div className="bg-card/50 rounded-xl p-1 border border-border/30">
                                            <button
